...
### `index.html` — Accueil
 ...
 Bannière animée (slideshow CSS)
 Section services (cartes interactives)
 Section À propos
 Section Contact + rendez-vous
 Modal de rendez-vous

### `pediatre.html` — Pédiatrie
 Hero bannière
 Section introduction
 Grille de 6 services pédiatriques
 Suivi par tranches d'âge (0–18 ans)
 CTA + Footer

### `prenatal.html` — Prénatal
 Hero rose/mauve
 Suivi trimestre par trimestre (3 colonnes)
 6 services prénataux
 CTA + Footer

### `dentiste.html` — Dentiste
 Hero bannière dentaire
 6 soins dentaires
 Section technologie (4 équipements)
 Exemples de traitements
 Bannière urgence dentaire
 CTA + Footer

### `consultationGeneral.html` — Consultation Générale
 Hero avec image de fond
 3 info-cards (disponibilité, médecins, dossier)
 6 services médicaux
 CTA + Footer
